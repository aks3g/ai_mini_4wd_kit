# Sample Name: 009_sps_test.py
# 概要: 自己位置を推定しながらマシンを走らせます。
#       arr_mapは走行するコースによって差し替える必要があります。
#       006_sample_logging.py で生成されたログデータを
#       http://www.aks3g.com/log_visualizer.html のLearning Dataとして
#       読み込ませることでarr_mapが生成できます。
#
