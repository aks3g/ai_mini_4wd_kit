...
int aiMini4wdInitializeGpio(void)
{
	...
	samd51_gpio_configure(SAMD51_GPIO_A04, SAMD51_GPIO_IN, SAMD51_GPIO_NO_PULL, SAMD51_GPIO_MUX_FUNC_B);
	samd51_gpio_configure(SAMD51_GPIO_A05, SAMD51_GPIO_IN, SAMD51_GPIO_NO_PULL, SAMD51_GPIO_MUX_FUNC_B);
	samd51_gpio_configure(SAMD51_GPIO_A06, SAMD51_GPIO_IN, SAMD51_GPIO_NO_PULL, SAMD51_GPIO_MUX_FUNC_B);
	samd51_gpio_configure(SAMD51_GPIO_A07, SAMD51_GPIO_IN, SAMD51_GPIO_NO_PULL, SAMD51_GPIO_MUX_FUNC_B);

	//J QSPI
	samd51_gpio_configure(SAMD51_GPIO_A08, SAMD51_GPIO_INOUT, SAMD51_GPIO_PULLUP_DOWN, SAMD51_GPIO_MUX_FUNC_H);
	samd51_gpio_configure(SAMD51_GPIO_A09, SAMD51_GPIO_INOUT, SAMD51_GPIO_PULLUP_DOWN, SAMD51_GPIO_MUX_FUNC_H);
	samd51_gpio_configure(SAMD51_GPIO_A10, SAMD51_GPIO_INOUT, SAMD51_GPIO_PULLUP_DOWN, SAMD51_GPIO_MUX_FUNC_H);
	samd51_gpio_configure(SAMD51_GPIO_A11, SAMD51_GPIO_INOUT, SAMD51_GPIO_PULLUP_DOWN, SAMD51_GPIO_MUX_FUNC_H);
	samd51_gpio_configure(SAMD51_GPIO_B10, SAMD51_GPIO_INOUT, SAMD51_GPIO_PULLUP_DOWN, SAMD51_GPIO_MUX_FUNC_H);
	samd51_gpio_configure(SAMD51_GPIO_B11, SAMD51_GPIO_INOUT, SAMD51_GPIO_PULLUP_DOWN, SAMD51_GPIO_MUX_FUNC_H);
	...
	//J USB
	samd51_gpio_configure(SAMD51_GPIO_A23, SAMD51_GPIO_IN,    SAMD51_GPIO_PULLUP_DOWN, SAMD51_GPIO_MUX_DEFAULT);
